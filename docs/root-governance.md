# Root Governance: Cursor-SOP

Dokumen ini memuat aturan tingkat root untuk monorepo **Cursor SOP**.
...
- `.cursorrules`: Sebagai hukum interaksi AI khusus Cursor SOP.
...
- Konvensi penomoran & AI Persona (AI IDE Workflow Specialist).
